...
export default function Joinsection() {
    ...
    return (
        <div className=" relative   w-full h-60 bg-[#E5E5EF] flex flex-col justify-center items-center gap-4 text-center mt-20 ">
            ...
            <button onClick={navigatetosignup} className="  z-40  w-35 h-10 text-[15px] font-semibold rounded-[20px] text-white bg-[#4260DA]  hover:bg-transparent hover:border hover:text-black " >join us</button>
            <div className="">
