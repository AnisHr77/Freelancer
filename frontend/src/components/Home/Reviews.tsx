    ...
    return (
        <section className="w-full h-auto py-10">
            <div className="max-w-6xl mx-auto px-4 flex flex-col items-center">
                ...
                <p className=" text-[#585858] text-center w-155  text-[20px]  " >TaskLinker connects ambitious professionals with world-class opportunities, empowering seamless collaboration through secure, smart, and scalable freelance solutions.</p>
