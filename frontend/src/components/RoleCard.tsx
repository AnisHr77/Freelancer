...
export default function Role({ icon, userrole }: RoleProps) {
    return (
        <div className="flex justify-center items-center">
            <div className="w-72 sm:w-80 bg-white rounded-2xl overflow-hidden shadow-lg hover:shadow-[#3F5FFF] transition-shadow duration-300 group cursor-pointer border border-gray-200 hover:border-[#3F5FFF]">
